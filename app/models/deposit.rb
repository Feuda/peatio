class Deposit < ActiveRecord::Base
  ...
  def aggregate_funds
      if currency.code.upcase == 'ETH'
        ...
        agg_txid = CoinRPC[channel.currency_obj.code].eth_sendTransaction(
          from: payment_tx.address,
          to: channel.currency_obj.base_account, 
          gas: "0x" + gas_limit.to_s(16), 
          gasPrice: "0x" + gas_price.to_s(16), 
          nonce: "0x" + local_nonce.to_s(16), 
          value: "0x" + local_amount.to_s(16)) 
      end
  end
